...
class TrustScoreCalculator:
    ...
    # Severity multiplier per anomaly flag type
    FLAG_WEIGHTS = {
        FlagType.GAZE_OFFSCREEN: 2.0,      # Minor penalty per gaze deflection
        FlagType.NO_FACE_DETECTED: 4.0,     # Moderate penalty when student leaves frame
        FlagType.AUDIO_DISTURBANCE: 3.0,    # Moderate penalty for background voices
        FlagType.MULTIPLE_FACES: 12.0,     # Severe penalty for multiple people in frame
    }
